export const codegenNodePrompt = (params) => {
    const { task, codegenIndex, collectedContext, isNewProject, requestTypeLabel } = params;
    return `
...
//# sourceMappingURL=codegenNodePrompt.js.map