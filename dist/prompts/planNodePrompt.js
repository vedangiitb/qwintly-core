export const planNodePrompt = (params) => {
    const { planTasks, collectedContext, plannerIndex, isNewProject, requestTypeLabel } = params;
    return `
...
//# sourceMappingURL=planNodePrompt.js.map